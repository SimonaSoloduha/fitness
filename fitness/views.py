...
def advertising(request):
    pdf_path = Path(settings.BASE_DIR) / 'templates' / 'advertising' / 'SimonaSoloduha_MediaKit.pdf'
    ...
    return render(request, 'advertising/advertising.html', {
        'pdf_url': request.build_absolute_uri('?embed=1')
    })
...
#         raise Http404('PDF not found')
#
#     # Имя файла для встроенного показа
...
#             max-width:98%;height:auto !important;
